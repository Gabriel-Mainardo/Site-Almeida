      ...
      <div className="container mx-auto py-10 md:py-16 px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
          <div className="relative">
            ...
            <p className="text-cream/80 mb-5 md:mb-8 text-sm md:text-base text-center sm:text-left">
            ...
            <div className="absolute -bottom-2 -right-2 w-6 h-6 sm:w-8 sm:h-8 border-r-2 border-b-2 border-gold/40 hidden sm:block"></div>
          </div>
          
          <div className="relative mt-6 sm:mt-0">
            <h3 className="font-bold text-base sm:text-lg mb-4 md:mb-6 text-gold inline-block relative text-center sm:text-left w-full sm:w-auto">
              Links Rápidos
              <span className="absolute -bottom-2 left-0 right-0 sm:right-auto sm:w-12 h-0.5 bg-gold/40 mx-auto sm:mx-0"></span>
            </h3>
            <ul className="space-y-3 md:space-y-3 text-center sm:text-left">
              {['Início', 'Sobre', 'Serviços', 'Portfólio', 'Depoimentos', 'Contato'].map((item, index) => (
                <li key={index}>
                  <a 
                    href={`#${item.toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g, '')}`} 
                    className="text-cream/80 hover:text-gold transition-colors duration-300 flex items-center justify-center sm:justify-start text-sm md:text-base touch-target py-1"
                  >
                    <span className="w-1.5 h-1.5 bg-gold/50 rounded-full mr-2.5 hidden sm:inline-block"></span>
                    {item}
                    <span className="ml-2 transition-transform duration-300 transform translate-x-0 opacity-0 group-hover:opacity-100 group-hover:translate-x-1 hidden sm:inline-block">→</span>
                  </a>
                </li>
              ))}
            </ul>
          ...
          <div className="relative mt-6 md:mt-0">
            ...
            <div className="space-y-3 md:space-y-5 text-center sm:text-left">
              <p className="flex items-start justify-center sm:justify-start">
                <Phone size={16} className="mr-2 sm:mr-3 text-gold flex-shrink-0 mt-1" />
                <span className="text-cream/80 hover:text-cream transition-colors duration-300 text-sm md:text-base">+55 (51) 99999-9999</span>
              </p>
              <p className="flex items-start justify-center sm:justify-start">
                <Mail size={16} className="mr-2 sm:mr-3 text-gold flex-shrink-0 mt-1" />
              ...
              <div className="flex items-start mb-3 md:mb-4 justify-center sm:justify-start">
                <Instagram size={16} className="mr-2 sm:mr-3 text-gold flex-shrink-0 mt-1" />
                <div>
              ...
              <p className="flex items-start justify-center sm:justify-start">
                <MapPin size={16} className="mr-2 sm:mr-3 text-gold flex-shrink-0 mt-1" />
